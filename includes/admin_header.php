...
<header class="bg-white shadow-sm">
  <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
    <div class="flex items-center space-x-6">
      ...
      <nav class="hidden md:flex items-center">
        ...
        <a href="../admin/manage_student_balance.php" class="text-gray-600 hover:text-blue-600 transition-colors font-semibold px-4 py-2">Manage Balances</a>
  ...
  <div class="md:hidden hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
      ...
      <a href="../admin/manage_student_balance.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100">Manage Balances</a>
